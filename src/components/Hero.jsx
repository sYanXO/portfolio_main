        ...
        <section id="home" className="pt-24 md:pt-28 lg:pt-32 pb-16 md:pb-20 px-5 sm:px-6 min-h-[92vh] lg:min-h-screen flex flex-col justify-center relative overflow-hidden">
            ...
            <Reveal>
                <div className="max-w-4xl mx-auto w-full">
                    <div className={`inline-block px-3 py-1 mb-5 md:mb-6 text-[11px] md:text-xs font-bold tracking-widest uppercase rounded-full border ${theme.border} text-[#888888]`}>
                        Backend Systems Engineer
                    </div>
                    <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-extrabold tracking-tight mb-6 md:mb-8 leading-tight">
                        Building systems with <br />
                        <span className={`bg-clip-text text-transparent bg-gradient-to-r from-[#EDEDED] to-[#666666]`}>
                            Math & Code.
                        </span>
                    </h1>
                    <p className={`text-base sm:text-lg lg:text-xl max-w-2xl mb-10 md:mb-12 leading-relaxed ${theme.textMuted}`}>
                    ...
                    <div className="flex flex-wrap gap-3 md:gap-4 mb-12 md:mb-16">
                        <a href="mailto:desreayan@gmail.com" className={`px-6 py-3.5 md:px-8 md:py-4 rounded-lg font-bold transition-all duration-300 hover:-translate-y-1 hover:shadow-lg interactive-focus ${theme.button}`}>
                            Contact Me
                        </a>
                        <a
                            ...
                            className={`px-6 py-3.5 md:px-8 md:py-4 rounded-lg font-bold border transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex items-center gap-2 interactive-focus ${theme.border} hover:bg-[#333333] hover:text-[#FFFFFF] text-[#EDEDED]`}
                        >
